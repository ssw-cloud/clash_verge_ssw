...
**Applies to:** the customized Clash Verge Rev desktop application for Windows, macOS and
Linux, distributed from
<https://github.com/ssw-cloud/clash_verge_ssw/releases>.
...
- The **IP information card** on the Home page (Section 4.5) connects to
  third-party services by default. Section 6 explains how to stop these requests.
...
This customized build has no application update module and makes no requests
to check for or download application updates. New versions can be downloaded
